...
describe('Move', () => {
  ...
  // TODO: check if we can have the event for the folder renaming only or if we
  // always have an event for the file because we had an issue with this once.
  // See https://trello.com/c/5E43omt8
  ...
  describe('unsynced remote directory with content', () => {
    ...
    describe('before sync', () => {
      it.only('is created at destination', async () => {
        should(await helpers.remote.treeWithoutTrash()).deepEqual([
          'dst/',
          'src/',
          'src/dir/',
